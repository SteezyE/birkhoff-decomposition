...
-- input format --
bistochastic matrices in MatrixMarket format (*.mtx files)
https://math.nist.gov/MatrixMarket/formats.html

-- output format --
matrix size and permutation count on first line
factors and permutation are printed on subsequent lines (one line each)
factor and permutation pairs are seperated by empty lines
...
mmio library by the National Institue of Standards and Technology (NIST)
